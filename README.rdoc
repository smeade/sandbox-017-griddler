...
An application to experiment with the [Rails variants](http://edgeguides.rubyonrails.org/4_1_release_notes.html#action-pack-variants). Note the dedicated phone index view which shows only product name.
